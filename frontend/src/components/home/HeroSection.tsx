...
export default function HeroSection() {
  return (
    <section
  className="relative min-h-screen flex items-center overflow-hidden bg-white border-b border-black/10"
>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-[1rem] pb-20 lg:pt-[2rem]">
        <div className="max-w-3xl">
          ...
          <motion.h1
            ...
            style={{ fontSize: 'clamp(2.5rem, 6.5vw, 5.5rem)', lineHeight: '1.05', fontWeight: 600, color: 'var(--text-primary)' }}
          >
            More Than Cake —{' '}
            <em
          ...
          <motion.p
            ...
            style={{ fontSize: 'clamp(1rem, 1.8vw, 1.2rem)', color: 'rgba(5, 0, 0, 0.7)', lineHeight: '1.7' }}
          >
          ...
          >
            {[
              ...
              <div key={label} className="text-center">
                ...
                <p className="font-sans text-xs tracking-wide" style={{ color: 'rgba(0, 0, 0, 0.45)' }}>{label}</p>
              </div>
            ))}
          </motion.div>
        </div>
